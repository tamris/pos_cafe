                        ...
                        <tbody class="divide-y divide-slate-200 dark:divide-slate-700">
                            @forelse($transactions as $transaction)
                                <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors">
                                    ...
                                    <td class="px-6 py-4">
                                        <p class="text-xs font-semibold text-slate-900 dark:text-white block">
                    ...
                    <div class="p-6 bg-white dark:bg-slate-800 space-y-6">
                        <div class="grid grid-cols-2 gap-4 text-sm">
                            ...
                            <div>
                                ...
                                <p class="font-bold text-amber-600 dark:text-amber-400 uppercase text-xs">
                            ...
                            <div>
                                ...
                                <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-slate-100 dark:bg-slate-700 text-slate-800 dark:text-slate-300 border border-slate-200 dark:border-slate-600">
                                    {{ $selectedTransaction->payment_method === 'cash' ? 'Tunai' : ($selectedTransaction->payment_method === 'transfer' ? 'Transfer' : 'QRIS') }}
                                </span>
                            </div>
                        </div>
