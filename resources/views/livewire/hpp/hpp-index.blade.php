                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
                        ...
                        <div class="lg:col-span-5 space-y-3.5">
                            ...
                            <div class="p-4 sm:p-5 bg-slate-50 dark:bg-slate-900/50 rounded-2xl border border-slate-200 dark:border-slate-700 space-y-3">
                                ...
                                {{-- Biaya Operasional dengan Tooltip Hover & Auto Format --}}
                                <div class="flex justify-between items-center p-3 bg-white dark:bg-slate-800 rounded-xl border border-slate-200/80 dark:border-slate-700 gap-2"
                                     x-data="{
                                    ...
                                    <div class="flex items-center gap-2.5 min-w-0">
                                        ...
                                        <div>
                                            <div class="text-xs font-bold text-slate-800 dark:text-slate-200 flex items-center gap-1">
                                                ...
                                                <span class="group relative cursor-pointer inline-flex items-center">
                                            ...
                                            <div class="text-[10px] text-slate-400">Estimasi per porsi</div>
                                        </div>
                                    </div>
                                    <div class="relative w-28 shrink-0">
                                        ...
                                        <input type="text" 
                                               x-model="displayOp" 
                                               @input="formatOp($event.target.value)" 
                                               placeholder="0" 
                                               class="w-full pl-7 pr-2 py-1 text-xs sm:text-sm font-bold text-right bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-600 rounded-lg text-slate-900 dark:text-white focus:ring-2 focus:ring-emerald-500">
                                    </div>
                                </div>
                                ...
                                <div class="p-3.5 bg-emerald-50 dark:bg-emerald-950/40 rounded-xl border border-emerald-200 dark:border-emerald-800/60 flex items-center justify-between">
                                    <div>
                                        ...
                                        <span class="text-[10px] text-emerald-600/80 dark:text-emerald-400/80">Resep + Operasional</span>
                                    </div>
