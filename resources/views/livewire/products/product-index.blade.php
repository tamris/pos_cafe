                        ...
                        <div class="bg-white dark:bg-slate-800 px-6 py-4 space-y-4 max-h-[calc(100vh-200px)] overflow-y-auto">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <select id="category_id" wire:model.live="category_id" class="block w-full px-3 py-2.5 text-sm border border-slate-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-slate-900 dark:focus:ring-blue-500 focus:border-transparent bg-white dark:bg-slate-900 text-slate-900 dark:text-white">
                                ...
                                <div>
                                    <div class="flex items-center justify-between mb-2">
                                        <label for="sku" class="block text-sm font-medium text-slate-700 dark:text-slate-300">SKU <span class="text-red-500">*</span></label>
                                        <button type="button" wire:click="regenerateSku" class="inline-flex items-center text-xs font-semibold text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 transition-colors gap-1 group" title="Generate SKU otomatis">
                                    ...
                                    <div class="relative">
                                        <input type="text" id="sku" wire:model="sku" class="block w-full px-3 py-2.5 font-mono text-sm border border-slate-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-slate-900 dark:focus:ring-blue-500 focus:border-transparent bg-white dark:bg-slate-900 text-slate-900 dark:text-white" placeholder="Contoh: COF006">
                                    </div>
