...
<div class="min-h-screen w-full flex flex-col justify-between p-3.5 sm:p-6 lg:p-8 bg-slate-50 dark:bg-slate-950 transition-colors duration-300" 
    ...
    <header class="w-full max-w-5xl mx-auto flex items-center justify-between py-2 sm:py-3">
        <div class="flex items-center space-x-3">
            ...
            @else
                <div class="w-8 h-8 sm:w-9 sm:h-9 rounded-xl bg-amber-50 dark:bg-amber-950/40 text-amber-600 dark:text-amber-400 border border-amber-200/80 dark:border-amber-800/60 flex items-center justify-center shadow-2xs">
            ...
            <div>
                ...
                <span class="text-[9px] sm:text-[10px] text-amber-600 dark:text-amber-400 font-bold block uppercase tracking-wider">Point of Sale & Management</span>
            </div>
        </div>
            ...
            <div class="lg:col-span-7 bg-white dark:bg-slate-900 rounded-2xl p-5 sm:p-8 lg:p-9 border border-slate-200/80 dark:border-slate-800 shadow-sm flex flex-col justify-between transition-colors">
                <div>
                    ...
                    <div class="mb-5 sm:mb-6">
                        <div class="inline-flex items-center gap-2 px-2.5 py-1 rounded-md bg-amber-50 dark:bg-amber-950/40 border border-amber-200/80 dark:border-amber-800/60 text-amber-700 dark:text-amber-400 text-[10px] sm:text-[11px] font-semibold mb-2 sm:mb-3">
                        ...
                        <div class="space-y-1 sm:space-y-1.5">
                            ...
                            <div class="relative">
                                ...
                                <input type="email" id="email" wire:model.defer="email" placeholder="kasir@cafe.com" autofocus
                                    class="w-full pl-10 pr-3.5 py-2.5 sm:py-3 text-xs sm:text-sm border border-slate-300 dark:border-slate-600 rounded-xl focus:ring-2 focus:ring-slate-900 dark:focus:ring-blue-500 bg-white dark:bg-slate-800 text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 transition-all">
                            </div>
                            @error('email')
                        ...
                        <div class="space-y-1 sm:space-y-1.5">
                            ...
                            <div class="relative">
                                ...
                                <input :type="showPassword ? 'text' : 'password'" id="password" wire:model.defer="password" placeholder="••••••••"
                                    class="w-full pl-10 pr-10 py-2.5 sm:py-3 text-xs sm:text-sm border border-slate-300 dark:border-slate-600 rounded-xl focus:ring-2 focus:ring-slate-900 dark:focus:ring-blue-500 bg-white dark:bg-slate-800 text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 transition-all">
                        ...
                        <div class="flex items-center justify-between pt-1">
                            <label for="remember" class="inline-flex items-center gap-2 cursor-pointer select-none">
                                <input type="checkbox" id="remember" wire:model="remember"
                                    class="w-4 h-4 text-slate-900 dark:text-blue-600 border-slate-300 dark:border-slate-600 rounded focus:ring-slate-900 dark:focus:ring-blue-500 bg-white dark:bg-slate-800 cursor-pointer">
...
<div class="pt-2">
    <button type="submit" 
        ...
        wire:target="login"
        class="w-full h-11 sm:h-12 bg-slate-900 hover:bg-slate-800 dark:bg-blue-600 dark:hover:bg-blue-700 text-white rounded-xl text-xs sm:text-sm font-bold shadow-xs hover:shadow-sm focus:outline-none focus:ring-2 focus:ring-slate-900/20 dark:focus:ring-blue-500/30 focus:ring-offset-2 dark:focus:ring-offset-slate-900 transition-all duration-150 active:scale-[0.99] disabled:opacity-75 disabled:cursor-not-allowed select-none flex items-center justify-center gap-2 cursor-pointer">
        ...
        {{-- Teks Tombol (Berganti otomatis di posisi yang sama persis) --}}
            ...
            <div class="lg:col-span-5 flex flex-col gap-3.5 sm:gap-4 lg:gap-5 justify-between">
                ...
                <div class="bg-slate-900 dark:bg-slate-900 text-white rounded-2xl p-4 sm:p-5 lg:p-6 border border-slate-800 shadow-sm flex flex-col justify-between"
                    ...
                    <div class="pt-2.5 sm:pt-3 border-t border-slate-800 flex items-center justify-between text-[11px] sm:text-xs text-slate-400">
                        <span class="flex items-center gap-1.5">
                            <svg class="w-3.5 h-3.5 sm:w-4 sm:h-4 text-amber-400" fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24">
                ...
                <div class="bg-white dark:bg-slate-900 rounded-2xl p-4 sm:p-5 border border-slate-200/80 dark:border-slate-800 shadow-sm flex items-center justify-between transition-colors">
                    <div class="flex items-center space-x-3 sm:space-x-3.5 min-w-0">
                        <div class="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-700 flex items-center justify-center shrink-0">
                            <svg class="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24">
                ...
                <div class="bg-white dark:bg-slate-900 rounded-2xl p-4 sm:p-5 border border-slate-200/80 dark:border-slate-800 shadow-sm flex flex-col justify-between transition-colors">
                    <div class="flex items-center justify-between mb-2.5 sm:mb-3">
                        <div class="flex items-center space-x-2">
                            <div class="w-5 h-5 sm:w-6 sm:h-6 rounded-lg bg-amber-50 dark:bg-amber-950/40 text-amber-600 dark:text-amber-400 flex items-center justify-center">
